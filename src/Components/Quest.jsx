...
const Quest=({quest,reward,viewQuest,addQuest})=>{
    ...
    <div id="quest-parent">
      <div id="quest-container">
        ...
        <div style={{display: "inline-block"}}>
          <button id="accept" onClick={()=>{allowMove();viewQuest("accepted");addQuest(quest.questTitle,quest.questTrack1,quest.questTrack2)}}>Accept</button>
          <button id="decline" onClick={()=>{allowMove();viewQuest("declined")}}>Decline</button>
        </div>
      </div>
    </div>
  )
